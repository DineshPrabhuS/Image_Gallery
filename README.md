...
<html>
    ...
    text-align: center;
    padding: 20px;
    background-color: rgba(121, 28, 112, 0.9);
    width: 100%;
    ...
    padding: 10px;
    width: 100%;
    background-color: rgba(110, 19, 92, 0.9);
    }
...
<div class="footer">
    <p><b>Designed by Dinesh Prabhu S(24004388)</b></p>
</div>
...
![alt text](image.png)
![alt text](<Screenshot 2024-12-25 104249.png>)
![alt text](<Screenshot 2024-12-25 104327.png>)
